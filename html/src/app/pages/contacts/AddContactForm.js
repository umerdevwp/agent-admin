...
const AddContactForm = (props) => {
    ...
    const addressCheck = async () => {
        if (!userAgree && !isValidAddress && addressObject.streetLine && inputContactCity.value && inputContactState.value && inputContactZipcode.value) {
            let lookup1 = new Lookup();
            lookup1.street = addressObject.streetLine;
