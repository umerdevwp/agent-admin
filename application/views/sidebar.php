...
<?php if($this->session->user["isAdmin"]): ?>
  <li class="rd-navbar-nav-item"><a class="rd-navbar-link" href="<?= base_url('admin') ?>"><span class="rd-navbar-icon fa-lock"></span><span class="rd-navbar-link-text">Administrator</span></a> </li>
<?php endif; ?>